describe('Car service', function () {
    describe('isItExpensive', function () {
        ...
        it('If issue is Transmission to not answer cheaper', () => {
            expect(carService.isItExpensive('a')).to.not.equal(`The overall price will be a bit cheaper`);
        });
    });
